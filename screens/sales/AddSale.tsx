        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <View style={styles.flexButtons}>
              ...
              <Pressable style={[styles.button, styles.buttonClose]} onPress={() => setModalProduct(false)}>
                <Text>Manual</Text>
              </Pressable>
              <Pressable style={[styles.button, styles.buttonOpen]} onPress={() => setModalProduct(false)}>
